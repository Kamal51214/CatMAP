...
yc = [float(a[1][1]) for a in model.turnover_frequency_map]
...
asd*=e #C/sqcm
asd*=1000. #mC/sqcm
asd*=8 #multiply by number of electrons, divide by number of CO2
...
plt.title('Simulated polarization curves for CH4_g coverage at pH=13, Partial pressure=0.035')
